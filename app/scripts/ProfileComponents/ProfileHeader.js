  ...
  render: function() {
    ...
    if (this.props.session.username === this.props.route) {
      sessionNavSection = (
        ...
        this.props.sentMatch
        && this.props.sentMatch.sender === this.props.session.username
        && this.props.route !== this.props.session.username) {
          // console.log(this.props.sentMatch);
        heartIcon = (<i className="icon-heart sent-match fa fa-heart" aria-hidden="true" onClick={this.toggleMatch}></i>);
    ...
    return (
      <div className="profile-header-container">
        <div className="profile-header-images" style={stylesBkgrndImgs}>
